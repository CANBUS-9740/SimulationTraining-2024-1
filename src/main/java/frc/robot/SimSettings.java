...
public class SimSettings {
    ...
    public static final double ARM_BOTTOM_MIN_ANGLE = Math.toRadians(RobotMap.ARM_BOTTOM_MIN_ANGLE);
    public static final double ARM_BOTTOM_MAX_ANGLE = Math.toRadians(RobotMap.ARM_BOTTOM_MAX_ANGLE);
    public static final double ARM_TOP_MIN_ANGLE = Math.toRadians(RobotMap.ARM_TOP_MIN_ANGLE);
    public static final double ARM_TOP_MAX_ANGLE = Math.toRadians(RobotMap.ARM_TOP_MAX_ANGLE);
